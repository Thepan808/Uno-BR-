...
def display_color_group(color, game):
    """ Convert a color code to actual color name """
    if color == "r":
        return __("{emoji} Vermelho", game.translate).format(
            emoji='❤️')
    if color == "b":
        return __("{emoji} Azul", game.translate).format(
            emoji='💙')
    if color == "g":
        return __("{emoji} Verde", game.translate).format(
            emoji='💚')
    if color == "y":
        return __("{emoji} Amarelo", game.translate).format(
            emoji='💛')
